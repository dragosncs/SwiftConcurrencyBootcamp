...
//
//  Created by Dragos Neacsu on 07.11.2023.
//
...
//        classTest2()
    ...
    private func classTest1(){
        ...
        let objectB = MyClass(title: "Starting Title!")
        print("ObjectA: ", objectB.title)
    ...
    private func actorTest1() {
        Task{
            ...
            print("Pass the REFERENCE of objectA to objectB.")
            let objectB = MyActor(title: "Starting Title!")
            await print("ObjectA: ", objectB.title)
